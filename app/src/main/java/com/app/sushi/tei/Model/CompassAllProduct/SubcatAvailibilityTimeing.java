...
public class SubcatAvailibilityTimeing implements Parcelable {

	public SubcatAvailibilityTimeing(){
	...
	protected SubcatAvailibilityTimeing(Parcel in) {
	}

	public static final Creator<SubcatAvailibilityTimeing> CREATOR = new Creator<SubcatAvailibilityTimeing>() {
		@Override
		public SubcatAvailibilityTimeing createFromParcel(Parcel in) {
			return new SubcatAvailibilityTimeing(in);
		}

		@Override
		public SubcatAvailibilityTimeing[] newArray(int size) {
			return new SubcatAvailibilityTimeing[size];
		}
	};
