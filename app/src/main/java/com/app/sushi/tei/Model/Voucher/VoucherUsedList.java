...
public class VoucherUsedList implements Serializable {
    ...
    @SerializedName("voucher_used_count")
    private String voucherUsedCount;
    ...
    public String getVoucherUsedCount() {
        return voucherUsedCount;
    }

    public void setVoucherUsedCount(String voucherUsedCount) {
