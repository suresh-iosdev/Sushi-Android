...
public class ViewOrderDetailActivity extends Activity {
    ...
    TextView tv_order_date, tv_order_time, tv_order_no, textView,
            ...
            discountLeftTextView, discountTextView, txtOutletAddress, txtDiscountLabel, txtGstLabel,
            txtDiscountTotalRedeem,txtpacking_charge;
...
//        txtGSTLabel = (TextView) findViewById(R.id.txtGSTLabel);
        ...
        GlobalValues.GstChargers = Utility.readFromSharedPreference(ViewOrderDetailActivity.this, GlobalValues.GstCharger);
...
//            orderDetail = gson.fromJson(intent.getStringExtra("ORDER_DETAIL"), OrderDetail.class);
            ...
            Log.e("foooooo", String.valueOf(intent.getParcelableExtra("ORDER_DETAIL")));

            Log.e("TAG","PackagingChargeTestdsdfa::"+GlobalValues.PACKING_CHARGE_SHOW);
            Double val= Double.valueOf(GlobalValues.PACKING_CHARGE_SHOW);
            if (val > 0) {
     //       if (GlobalValues.PACKING_CHARGE_SHOW>0) {
                layoutpackingcharge.setVisibility(View.VISIBLE);
                txtpacking_charge.setText(GlobalValues.PACKING_CHARGE_SHOW);
            }else {
...
/*        ViewrewardsAdaptersnew viewOrderListAdapter = new ViewrewardsAdaptersnew(ViewOrderDetailNewActivity.this, orderDetail.getItems_json_array_string());
        ...
        ViewrewardsAdaptersnew viewOrderListAdapter = new ViewrewardsAdaptersnew(ViewOrderDetailActivity.this, orderDetail.getItems_json_array_string());
        final LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ViewOrderDetailActivity.this, LinearLayoutManager.VERTICAL, false);
        recyler_view_ordered_products.setLayoutManager(linearLayoutManager);
        recyler_view_ordered_products.setAdapter(viewOrderListAdapter);
    ...
    protected void onResume() {
        ...
        Utility.writeToSharedPreference(ViewOrderDetailActivity.this, "IS_ACTIVE", "1");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Utility.writeToSharedPreference(ViewOrderDetailActivity.this, "OREO_UPDATE", "1");
        }
//        GlobalValues.currentVisibleActivity = this;
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("ok")) {
                    Toast.makeText(ViewOrderDetailActivity.this, jsonObject.optString("message"), Toast.LENGTH_SHORT).show();
    ...
    protected void onPause() {
        super.onPause();
        Utility.writeToSharedPreference(ViewOrderDetailActivity.this, "IS_ACTIVE", "0");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Utility.writeToSharedPreference(ViewOrderDetailActivity.this, "OREO_UPDATE", "1");
        }
    }
