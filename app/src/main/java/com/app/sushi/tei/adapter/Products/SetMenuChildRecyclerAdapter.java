...
import static com.app.sushi.tei.activity.SubCategoryActivity.*;
...
public class SetMenuChildRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private SpannableString cs;
    private Double subtotalPrice = 0.0;
    SetMenuModifierRecyclerAdapter setMenuModifierRecyclerAdapter;
    private int lastSelectedPosition = -1;
    private List<String> checkedList = new ArrayList<>();
    int count = 0;
    Double modifierPrice;
    public static double childPlusMinus = 0.00;


    public SetMenuChildRecyclerAdapter(Context mContext, List<SetMenuModifier> setMenuModifierList, int minmaxSelect,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (minmaxSelect == 1) {
            if (setMenuTitleList.get(mParentPosition).getmenu_component_modifier_apply().equalsIgnoreCase("0")) {
                if (setMenuTitleList.get(mParentPosition).getmultipleselection_apply().equalsIgnoreCase("0")) {
        ...
        if (holder instanceof ChildHolderApply0) {
            ...
            if (setMenuModifierList.get(position).getModifierHeadingList() != null) {
                ...
                if (setMenuModifierList.get(position).getModifierHeadingList().size() > 0) {
                    ...
                    setMenuModifierRecyclerAdapter = new SetMenuModifierRecyclerAdapter(mContext,
                ...
                public void onClick(View v) {
                    ...
                    if (totalcount <= maxselect) {
                        ...
                        if (Integer.parseInt(setMenuTitleList.get(mParentPosition).getmAppliedPrice()) == 1) {
                            ...
                            SubCategoryActivity.mSetmenuoverallprices = price * count;




                            //Double quantityCost_Menu = SubCategoryActivity.mSetmenuoverallprices + quantityCost;
                            Double quantityCost_Menu = Double.parseDouble(txtModifierPrice.getText().toString()) + (price * mSetMenuQuantity);
                            childPlusMinus += price;

                            SubCategoryActivity.mquanititycost_src = quantityCost_Menu;
                  ...
                  *//*                  for (int j = 0; j < setMenuTitleList.get(i).getSetMenuModifierList().size(); j++) {
                                ...
                                SubCategoryActivity.mSetmenuoverallprices = price * Total;
...
//                    mPosition = position;
    ...
    public void multiselection(int position) {
        count++;
        GlobalValues.modifierSelectCount = count;
        double price = Double.parseDouble(setMenuModifierList.get(position).getmModifierPrice());
        if (setMenuModifierList.get(position).isChecked()) {
            childHolderApply0.imgChecked.setImageResource(R.drawable.asset53);
        } else {
        ...
        if (setMenuModifierList.get(position).isChecked()) {
            ...
            if (!setMenuModifierList.get(position).getHasModifier()) {
                ...
                checkedList.add(setMenuModifierList.get(position).getmModifierId());
                mSetMenuPrice = mSetMenuPrice - price;
                quantityCost = mSetMenuPrice * mSetMenuQuantity;
                quantityCost = mSetMenuPrice;
                Double mtotalPrice = mSetMenuPrice * mSetMenuQuantity;
    ...
    /*public void singleSelectionforDoubleTitle(int position) {
        ...
        if (setMenuModifierList.get(position).isChecked()) {
            ...
            if (setMenuModifierList.get(position).getHasModifier()) {
                ...
                for (int k = 0; k < setMenuTitleList.size(); k++) {
                    ...
                    if (titale3.equalsIgnoreCase(setMenuTitleList.get(k).getmTitleMenuName())) {
                        ...
                        subtotalPrice = mSetMenuPrice - price - modifierPrice;
                        mSetMenuPrice = subtotalPrice;
                        quantityCost = (mSetMenuPrice + totalDoubleTitlePrice3) * mSetMenuQuantity;
                        Double mtotalPrice = (mSetMenuPrice + totalDoubleTitlePrice3) * mSetMenuQuantity;
                        txtModifierPrice.setText(Utility.setPriceSpan(mContext, mtotalPrice));

                    }
                }

                doubletitle = totalDoubleTitlePrice3;
                ...
                doubletitle = totalDoubleTitlePrice2;

                subtotalPrice = mSetMenuPrice - price;
                mSetMenuPrice = subtotalPrice;
                if (mSetMenuPrice == 0.0) {
                    mSetMenuPrice = mSetMenuBasePrice;
                }
                quantityCost = (mSetMenuPrice + totalDoubleTitlePrice2) * mSetMenuQuantity;
                Double mtotalPrice = (mSetMenuPrice + totalDoubleTitlePrice2) * mSetMenuQuantity;
                txtModifierPrice.setText(Utility.setPriceSpan(mContext, mtotalPrice));
            ...
            doubletitle = totalDoubleTitlePrice;
            ...
            if (setMenuModifierList.get(position).getHasModifier()) {
                ...
                subtotalPrice = mSetMenuPrice + price;
                mSetMenuPrice = subtotalPrice;
                quantityCost = (mSetMenuPrice + totalDoubleTitlePrice) * mSetMenuQuantity;

                Double mtotalPrice = (mSetMenuPrice + totalDoubleTitlePrice) * mSetMenuQuantity;
                txtModifierPrice.setText(Utility.setPriceSpan(mContext, mtotalPrice));
                childHolderApply0.modifiersRecyclerView.setVisibility(View.VISIBLE);
                ...
                doubletitle = totalDoubleTitlePrice1;
                childHolderApply0.modifiersRecyclerView.setVisibility(View.GONE);

                subtotalPrice = mSetMenuPrice + price;
                mSetMenuPrice = subtotalPrice;
                quantityCost = (mSetMenuPrice + totalDoubleTitlePrice1) * mSetMenuQuantity;

                Double mtotalPrice = (mSetMenuPrice + totalDoubleTitlePrice1) * mSetMenuQuantity;
                txtModifierPrice.setText(Utility.setPriceSpan(mContext, mtotalPrice));
        ...
        if (setMenuModifierList.get(position).isChecked()) {
            ...
            if (setMenuModifierList.get(position).getHasModifier()) {
                ...
                for (int k = 0; k < setMenuTitleList.size(); k++) {
                    ...
                    for (int j = 0; j < setMenuModifierList1.size(); j++) {
                        if (setMenuModifierList1.get(j).isChecked()) {
                            if (setMenuModifierList1.get(j).getApplyPrice().equalsIgnoreCase("1")) {
                                doubleTitlePrice3 = Double.valueOf(setMenuModifierList1.get(j).getmModifierPrice());
                                totalDoubleTitlePrice3 = totalDoubleTitlePrice3 + doubleTitlePrice3;
                ...
                mtotalPrice = (mSetMenuPrice + subModifierPrice + childPlusMinus) * mSetMenuQuantity;
                ...
                quantityCost = (mSetMenuPrice + totalDoubleTitlePrice2) * mSetMenuQuantity;
                Double mtotalPrice = (mSetMenuPrice + totalDoubleTitlePrice2 + subModifierPrice + childPlusMinus) * mSetMenuQuantity;
                txtModifierPrice.setText(String.format("%.2f", new BigDecimal(mtotalPrice)));
            ...
            if (setMenuModifierList.get(position).getHasModifier()) {
                ...
                Double mtotalPrice = (mSetMenuPrice + subModifierPrice + childPlusMinus) * mSetMenuQuantity;
                txtModifierPrice.setText(String.format("%.2f", new BigDecimal(mtotalPrice)));
