...
public class SetMenuTitleRecyclerAdapter extends RecyclerView.Adapter<SetMenuTitleRecyclerAdapter.TitleHolder> {
    ...
    public SetMenuTitleRecyclerAdapter(Context mContext, List<SetMenuTitle> setMenuTitleList, int minmaxSelect, String Status) {
        this.mContext = mContext;
        this.setMenuTitleList = setMenuTitleList;
        this.minmaxSelect = minmaxSelect;
        this.Status = Status;
        Log.e("quantTitle", quantityCost + "--");
    ...
    public void onBindViewHolder(final TitleHolder holder, int position) {
        ...
        setMenuTitleList.get(position).setSetMenuTitleSelectCount(setMenuTitleList.get(position).getmMinSelect());
        ...
        if (setMenuTitleList.get(position).getSetMenuModifierList() != null) {
            if (setMenuTitleList.get(position).getSetMenuModifierList().size() > 0) {
                ...
                setMenuChildRecyclerAdapter = new SetMenuChildRecyclerAdapter(mContext,
