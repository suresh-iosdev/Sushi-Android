package com.app.sushi.tei.adapter.Products1;
...
import static com.app.sushi.tei.adapter.Bento.BentoProductRecyclerAdapter.mModifierPrice;
import static com.app.sushi.tei.adapter.Bento.BentoProductRecyclerAdapter.mModifierQuantity;
import static com.app.sushi.tei.adapter.Bento.BentoProductRecyclerAdapter.quantityCost;
import static com.app.sushi.tei.adapter.Bento.BentoProductRecyclerAdapter.txtModifierPrice;


public class ModifierHeadingRecyclerAdapter2 extends RecyclerView.Adapter<ModifierHeadingRecyclerAdapter2.ModifierHeadingHolder> {
    ...
    public ModifierHeadingRecyclerAdapter2(Context mContext, List<ModifierHeading> modifierHeadingList, String productId) {
    ...
    @Override
    public ModifierHeadingRecyclerAdapter2.ModifierHeadingHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ModifierHeadingRecyclerAdapter2.ModifierHeadingHolder holder, int position) {
