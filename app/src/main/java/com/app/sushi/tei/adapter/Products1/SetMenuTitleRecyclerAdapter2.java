...
public class SetMenuTitleRecyclerAdapter2 extends RecyclerView.Adapter<SetMenuTitleRecyclerAdapter2.TitleHolder> {
   ...
   // private SetMenuChildRecyclerAdapter setMenuChildRecyclerAdapter;
    ...
    public SetMenuTitleRecyclerAdapter2(Context mContext, List<SetMenuTitle> setMenuTitleList, int minmaxSelect, String Status) {
