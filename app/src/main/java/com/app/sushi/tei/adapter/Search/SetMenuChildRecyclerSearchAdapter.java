...
public class SetMenuChildRecyclerSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SetMenuChildRecyclerSearchAdapter(Context mContext, List<SetMenuModifier> setMenuModifierList, int minmaxSelect,
                ...
                public void onClick(View v) {
                    ...
                    if (totalcount <= maxselect)
                    {
                        ...
                        if (Integer.parseInt(setMenuTitleList.get(mParentPosition).getmAppliedPrice()) == 1) {
                          ...
                          Double quantityCost_Menu = SubCategoryActivity.mSetmenuoverallprices +  SubCategoryActivity.quantityCost;


                            SubCategoryActivity.mquanititycost_src = quantityCost_Menu;


                            SubCategoryActivity.txtModifierPrice.setText(String.format("%.2f", new BigDecimal( quantityCost_Menu)));
...
//                    mPosition = position;
            ...
            if (setMenuModifierList.get(position).isChecked()) {
                ...
                if (setMenuModifierList.get(position).getHasModifier()) {
                    ...
                    SubCategoryActivity.quantityCost = SubCategoryActivity.mSetMenuPrice * SubCategoryActivity.mSetMenuQuantity;
                    Double mtotalPrice = SubCategoryActivity.mSetMenuPrice * SubCategoryActivity.mSetMenuQuantity;
    ...
    public void multiselection(int position){
        ...
        if (setMenuModifierList.get(position).isChecked()) {
            ...
            if (!setMenuModifierList.get(position).getHasModifier())
            {
                ...
                SubCategoryActivity.mSetMenuPrice = SubCategoryActivity.mSetMenuPrice - price;
                SubCategoryActivity.quantityCost = SubCategoryActivity.mSetMenuPrice * SubCategoryActivity.mSetMenuQuantity;
                SubCategoryActivity.quantityCost = SubCategoryActivity.mSetMenuPrice;
                Double mtotalPrice= SubCategoryActivity.mSetMenuPrice* SubCategoryActivity.mSetMenuQuantity;
                SubCategoryActivity.txtModifierPrice.setText(String.format("%.2f", new BigDecimal( mtotalPrice)));
            ...
            double temporaryPrice = SubCategoryActivity.mSetMenuPrice;
            ...
            SubCategoryActivity.mSetMenuPrice = temporaryPrice;
