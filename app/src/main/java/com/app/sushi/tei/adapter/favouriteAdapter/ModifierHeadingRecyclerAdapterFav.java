...
import com.app.sushi.tei.adapter.Products.ModifierChildRecyclerAdapter;
...
import static com.app.sushi.tei.activity.HomeActivity.mModifierQuantity;
...
import static com.app.sushi.tei.adapter.favouriteAdapter.FavouriteAdapter.isCorrectCombination;
import static com.app.sushi.tei.adapter.favouriteAdapter.FavouriteAdapter.mAliasProductPrimaryId;


public class ModifierHeadingRecyclerAdapterFav extends RecyclerView.Adapter<ModifierHeadingRecyclerAdapterFav.ModifierHeadingHolder> {
...
public ModifierHeadingRecyclerAdapterFav(Context mContext, List<ModifierHeading> modifierHeadingList, String productId) {
...
@Override
public ModifierHeadingHolder onCreateViewHolder(ViewGroup parent, int viewType) {
...
@Override
public void onBindViewHolder(ModifierHeadingHolder holder, int position) {
        ...
        final ModifierChildRecyclerAdapter modifierChildRecyclerAdapter = new ModifierChildRecyclerAdapter(mContext, modifierHeadingList, modifierHeadingList.get(position).getModifiersList(), position);
        ...
        try {
            ...
            if (jsonObject.getString("status").equalsIgnoreCase("ok")) {
                ...
                for (int i = 0; i < jsonResult.length(); i++) {
                    ...
                    mModifierPrice = Double.parseDouble(json.getString("product_price"));

                    quantityCost=(double) mModifierQuantity* mModifierPrice;


                    final String price= String.format("%.2f",new BigDecimal(quantityCost+""));
