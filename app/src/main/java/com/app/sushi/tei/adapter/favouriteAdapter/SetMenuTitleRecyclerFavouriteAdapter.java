...
public class SetMenuTitleRecyclerFavouriteAdapter extends RecyclerView.Adapter<SetMenuTitleRecyclerFavouriteAdapter.TitleHolder> {
    ...
    public SetMenuTitleRecyclerFavouriteAdapter(Context mContext, List<SetMenuTitle> setMenuTitleList, int minmaxSelect, String Status) {
    ...
    public void onBindViewHolder(final TitleHolder holder, int position) {
        ...
        if (setMenuTitleList.get(position).getSetMenuModifierList() != null) {
            if (setMenuTitleList.get(position).getSetMenuModifierList().size() > 0)
            {
                ...
                setMenuChildRecyclerAdapter = new SetMenuChildRecyclerFavouriteAdapter(mContext,
