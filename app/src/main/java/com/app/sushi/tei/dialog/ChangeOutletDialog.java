...
public class ChangeOutletDialog {
    ...
    public ChangeOutletDialog(Context mContext, String cancel, String message, OnSlectedMethod onSlectedMethod) {
    ...
    public void showDialog() {
        ...
        dialog.setContentView(R.layout.dialog_change_outlet_layout);
