...
public class CheckOutMessageDialog {
    ...
    public CheckOutMessageDialog(Context context, String message, OnSlectedMethod onSlectedMethod) {
    ...
    public CheckOutMessageDialog(Context mContext, String cancel, String message, OnSlectedMethod onSlectedMethod) {
    ...
    public void showDialog() {
        ...
        dialog.setContentView(R.layout.dialog_all_message_layout);
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                selectedString.selectedAction("No");
                if (dialog.isShowing())
                    dialog.dismiss();
            }
        });
